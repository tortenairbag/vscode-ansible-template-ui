...
const COMPLETION_JINJA_FILTERS_SECTION = "Jinja Filters";
...
export const jinjaControlCompletions: Completion[] = [
  { label: "set", boost: 2, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "if", boost: 1, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "endif", boost: 1, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "for", boost: 1, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "endfor", boost: 1, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "macro", boost: 0, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "endmacro", boost: 0, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "call", boost: 0, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "endcall", boost: 0, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "filter", boost: 0, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
  { label: "endfilter", boost: 0, type: COMPLETION_JINJA_CONTROL_TYPE, section: COMPLETION_JINJA_CONTROL_SECTION },
];
...
export const jinjaFiltersCompletions: Completion[] = [
  { label: "abs", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "attr", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "batch", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "capitalize", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "center", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "default", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "dictsort", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "escape", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "filesizeformat", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "first", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "float", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "forceescape", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "format", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "groupby", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "indent", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "int", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "join", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "last", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "length", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "list", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "lower", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "map", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "max", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "min", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "pprint", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "random", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "reject", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "rejectattr", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "replace", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "reverse", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "round", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "safe", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "select", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "selectattr", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "slice", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "sort", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "string", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "striptags", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "sum", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "title", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "tojson", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "trim", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "truncate", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "unique", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "upper", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "urlencode", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "urlize", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "wordcount", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "wordwrap", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
  { label: "xmlattr", type: COMPLETION_JINJA_FILTERS_TYPE, section: COMPLETION_JINJA_FILTERS_SECTION, info: jinjaFiltersTooltipParser },
];
